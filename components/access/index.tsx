    ...
    return (
        <section className="flex flex-col items-center gap-3  w-full">
            ...
            <div className="font-bold text-sm tracking-wider relative flex justify-center items-center rounded-lg h-14 w-56 overflow-hidden bg-zinc-100">
                ...
                <span className={`transition-all ease-in-out rounded-full absolute w-1/2 h-full bg-white shadow-2xl shadow-black  ${model == 1 ? "left-0 bg-gradient-to-tr from-dark to-blue" : "left-28 bg-gradient-to-tr from-red-400 to-pink"} rounded-sm z-10`}></span>
            </div>
