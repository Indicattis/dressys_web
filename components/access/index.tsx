...
export default function AccessComponent() {
    ...
    return (
        <section className="flex flex-col items-center gap-3  w-full">
            <div className="p-[2px] bg-zinc-200 rounded-sm">
                <div className="font-bold text-sm tracking-wider relative flex justify-center items-center rounded-sm h-14 w-48 overflow-hidden bg-zinc-100">
                    ...
                    <span className={`transition-all ease-in-out rounded-full absolute w-1/2 h-full shadow-2xl shadow-black  ${model == 1 ? "left-0 bg-blue" : "left-24 bg-pink"} rounded-sm z-10`}></span>
                </div>
            </div>
